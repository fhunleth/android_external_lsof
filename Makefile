# linux Makefile for lsof revision 4.84

CC=	cc

CCV=	4.4.3 (Ubuntu 4.4.3-4ubuntu5) 

LIB=	lib/liblsof.a

CFGF=	 -DLINUXV=26032 -DGLIBCV=211 -DHASIPv6 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -DHAS_STRFTIME -DLSOF_VSTR=\"2.6.32-24-generic\"
